...
[![npm version](https://img.shields.io/npm/v/react-native-ble-manager.svg?style=flat)](https://www.npmjs.com/package/ut-smarthome-ble-manager)
[![npm downloads](https://img.shields.io/npm/dm/react-native-ble-manager.svg?style=flat)](https://www.npmjs.com/package/ut-smarthome-ble-manager)
[![GitHub issues](https://img.shields.io/github/issues/innoveit/react-native-ble-manager.svg?style=flat)](https://github.com/innoveit/ut-smarthome-ble-manager/issues)
...
## Install
```shell
npm i --save ut-smarthome-ble-manager
```
...
```shell
react-native link ut-smarthome-ble-manager
```
...
project(':ut-smarthome-ble-manager').projectDir = new File(rootProject.projectDir, '../node_modules/ut-smarthome-ble-manager/android')
```
##### Update Gradle Build
